...
export default function MediRxDashboard() {
  ...
  const handleConsult = (patient) => {
    navigate('/doctor/prescriptions/new', { state: { patient } });
  };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <button onClick={() => navigate('/doctor/prescriptions/new')} className="btn-primary w-full justify-center py-3">
